...
2. 1. All the steps below should be run within this terminal window. You can simply copy and paste the commands, and replace name where relevant.
...
6. Deploy your project to MM using: See [Deploying to MindModeling](#Deploying-to-MindModeling)
...
When you are ready to deploy your experiment to MindModeling, you will need to acquire a VM by contacting the MindModeling administrators.
