...
1. Generate a template for your project: `create-PsychoJS-project /path/to/project_script.js`. Replace the path with the path to your PsychoJS generated .js file.
