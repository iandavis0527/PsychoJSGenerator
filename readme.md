...
- The `machine_name` of your virtual machine. This will be an internal name only used by you and your team, and can be anything you like. You will use it to connect to your machine via the internet and configure files. Depending on the needs the administrator, this may be prepended with the letters `vm-`.
